        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl text-center max-w-md mx-4 transform animate-fadeInUp">
                ...
                <div className="relative mb-6">
                    ...
                    <div className="absolute -top-2 -left-2 text-4xl animate-bounce delay-300">✨</div>
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Your journey to making a positive impact starts now. Let's change the world together!
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="text-center">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">Start with</p>
...
export default function OnboardingPage() {
    ...
    useEffect(() => {
        const checkUsername = async () => {
            ...
            try {
                const response = await apiClient.get(`/users/check-username/${formData.username}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await apiClient.post('/users/onboarding', formData);
            await refetchUser();
                ...
                <div className="max-w-md w-full space-y-8">
                    ...
                    <div className="text-center">
                        <div className="flex items-center justify-center space-x-2 mb-4">
                            ...
                            <h1 className="text-2xl font-bold text-gradient-brand">Impact ID</h1>
                        </div>
