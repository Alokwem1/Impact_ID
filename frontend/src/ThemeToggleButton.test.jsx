...
describe('ThemeToggleButton (simple toggle)', () => {
  it('toggles theme between light and dark', () => {
    const { getByRole } = render(<ThemeToggleButton showDropdown={false} />, { wrapper: Wrapper });
...
describe('ThemeToggleButton (dropdown)', () => {
  it('opens dropdown and selects dark theme', () => {
    const { getByLabelText, getByText } = render(<ThemeToggleButton showDropdown={true} />, { wrapper: Wrapper });
    ...
    expect(darkWrapper?.className || '').toMatch(/text-blue-600|dark:text-blue-400/);
  });
});
