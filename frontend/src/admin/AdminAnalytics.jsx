...
export default function AdminAnalytics() {
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      const platformAnalyticsResponse = await apiClient.get(
      ...
      setAnalytics({
        ...
        active_users_today:
          platformAnalyticsResponse.data.active_users_today || 0,
        total_tasks_completed:
          platformAnalyticsResponse.data.total_tasks_completed || 0,
        total_badges_earned:
          platformAnalyticsResponse.data.total_badges_earned || 0,
