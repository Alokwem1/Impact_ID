...
export default function AdminCreateBadge() {
    ...
    const badgeTypes = [
        { value: 'achievement', label: 'Achievement', description: 'General accomplishments' },
        { value: 'milestone', label: 'Milestone', description: 'Significant progress markers' },
        { value: 'special', label: 'Special', description: 'Unique or limited-time badges' },
        { value: 'seasonal', label: 'Seasonal', description: 'Time-limited seasonal badges' },
        { value: 'community', label: 'Community', description: 'Community-driven achievements' }
    ];
    ...
    const criteriaTemplates = [
        { value: 'first_submission', label: 'First Submission', description: 'Complete first task' },
        ...
        { value: 'streak_7', label: '7-day Streak', description: 'Maintain 7-day streak' },
        { value: 'streak_30', label: '30-day Streak', description: 'Maintain 30-day streak' }
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(`Badge '${response.data.title}' created successfully!`, { id: toastId });
            ...
            const errorMessage = err.response?.data?.detail || 'Failed to create badge';
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-blue-100">Design and configure a new achievement badge</p>
                        </div>
                    </div>
                </div>
