...
export default function AdminCreateTask() {
    ...
    const taskTypes = [
        { value: 'report', label: 'Report', description: 'Text submission with detailed report' },
        { value: 'upload', label: 'Upload', description: 'File upload submission' },
        { value: 'quiz', label: 'Quiz', description: 'Multiple choice question' },
        { value: 'social_share', label: 'Social Share', description: 'Social media sharing task' },
        { value: 'survey', label: 'Survey', description: 'Survey completion' },
        { value: 'challenge', label: 'Challenge', description: 'Special challenge task' }
    ];
    ...
    const categories = [
        ...
        'Community', 'Arts', 'Sports', 'Business', 'Science', 'Other'
    ];
    ...
    const validateForm = () => {
        ...
        if (formData.time_limit_minutes && (formData.time_limit_minutes < 1 || formData.time_limit_minutes > 1440)) {
    ...
    const handleSubmit = (e) => {
        ...
        Object.keys(payload).forEach(key => {
            if (payload[key] === '' || (payload[key] === null && key !== 'time_limit_minutes' && key !== 'scheduled_start' && key !== 'scheduled_end')) {
                delete payload[key];
            }
        });
                ...
                <div className="bg-gradient-to-r from-green-600 to-blue-600 px-6 py-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-green-100">Design and configure a new impact task</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                        ...
                                        <button
                                            ...
                                            className={`p-2 rounded-md text-xs font-medium transition-all ${
                                                formData.difficulty === difficulty.value 
                                                    ? difficulty.color + ' ring-2 ring-offset-2 ring-blue-400' 
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${selectedDifficulty?.color}`}>
                                ...
                                {formData.essence_reward > 0 && (
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-gray-600">Essence Reward:</span>
                    ...
                    {formData.type === 'quiz' && (
                        <div className="bg-blue-50 rounded-lg p-4 space-y-4">
                            <div className="flex items-center">
                                ...
                                <h3 className="text-lg font-medium text-gray-900">Quiz Configuration</h3>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => handleQuizBuilderChange('question', e.target.value)}
                                    rows={3}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    ...
                                    {quizBuilder.options.map((option, index) => (
                                        <div key={index} className="flex items-center space-x-2">
                                            <input
                                                ...
                                                onChange={() => handleQuizBuilderChange('correct_index', index)}
                                                className="h-4 w-4 text-blue-600 focus:ring-blue-500"
                                            />
                                            <input
                                                type="text"
                                                value={option}
                                                onChange={(e) => handleQuizBuilderChange('options', e.target.value, index)}
                    ...
                    <div>
                        ...
                        {formData.tags.length >= 10 && (
                            <p className="text-xs text-orange-600 mt-1">Maximum 10 tags allowed</p>
                        )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label htmlFor="essence_reward" className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div className="border-t pt-6">
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Task Options</h3>
                        <div className="space-y-3">
                            <div className="flex items-center">
                                <input
                                    type="checkbox"
                                ...
                                />
                                <label htmlFor="requires_review" className="ml-2 block text-sm text-gray-900">
