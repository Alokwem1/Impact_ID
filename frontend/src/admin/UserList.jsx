...
export default function AdminUserList() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      // Backend admin router is mounted at /api/admin
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        >
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <strong>XP:</strong> {selectedUser?.xp}
              </div>
              <div>
                <strong>Level:</strong> {selectedUser?.level}
              </div>
              <div>
                <strong>Streak:</strong> {selectedUser?.streak} days
              </div>
              <div>
                <strong>Tasks:</strong> {selectedUser?.task_count}
              </div>
              <div>
                <strong>Badges:</strong> {selectedUser?.badge_count}
              </div>
              <div>
                <strong>Essence:</strong> {selectedUser?.essence_balance}
              </div>
              <div>
      ...
      {isModalOpen && modalType === "status" && (
        ...
        >
          <div className="space-y-4">
            <p>
              Update status for <strong>{selectedUser?.username}</strong>
            </p>
            <div>
              <label
                className="block text-sm font-medium text-gray-700 mb-1"
                htmlFor="modal-new-status"
              >
                New Status
              </label>
              <select
