    ...
    <div className={tooltip ? "relative group" : ""}>
      ...
      >
        ...
        {hasIcon && iconPosition === "left" && (
          <span className={hasChildren ? "mr-2" : ""}>{displayIcon}</span>
        )}
        ...
        {hasIcon && iconPosition === "right" && (
          <span className={hasChildren ? "ml-2" : ""}>{displayIcon}</span>
        )}
      </button>
...
export const XPButton = (props) => <Button variant="xp" {...props} />;

export const BadgeButton = (props) => <Button variant="badge" {...props} />;

export const ImpactButton = (props) => <Button variant="impact" {...props} />;
