...
export default function QuizResult({
  ...
  return (
    <div className="relative max-w-2xl mx-auto">
      ...
      {/* Main Results Card */}
      <div
        className={`bg-white rounded-2xl shadow-xl border-2 ${performanceLevel.borderColor} overflow-hidden`}
      >
        {/* Header */}
        <div
          className={`${performanceLevel.bgColor} px-8 py-6 text-center border-b ${performanceLevel.borderColor}`}
        >
          <div className="flex justify-center mb-4">
            <div
              className={`p-4 rounded-full ${performanceLevel.bgColor} ring-4 ring-white shadow-lg`}
            >
          ...
          <div
            className={`inline-flex items-center px-4 py-2 rounded-full ${performanceLevel.bgColor} ${performanceLevel.color} font-semibold text-lg`}
          >
        ...
        <div className="px-8 py-8 text-center">
          <div className="mb-6">
            ...
            <div className="flex items-center justify-center space-x-2 text-gray-600">
              ...
              <span className="text-lg">
                You scored <strong className="text-gray-900">{score}</strong>{" "}
                out of <strong className="text-gray-900">{total}</strong>{" "}
                questions correctly
              </span>
            </div>
          </div>
          ...
          {/* Performance Message */}
          <div
            className={`p-4 rounded-lg ${performanceLevel.bgColor} ${performanceLevel.borderColor} border`}
          >
          ...
          <div className="px-8 py-6 bg-blue-50 border-t border-blue-200">
            ...
            <ul className="space-y-2 text-blue-800">
              <li className="flex items-start space-x-2">
                <span>•</span>
                <span>
                  Review the material and take your time reading each question
                </span>
              </li>
              <li className="flex items-start space-x-2">
                <span>•</span>
                <span>
                  Practice with similar quizzes to improve your knowledge
                </span>
              </li>
              <li className="flex items-start space-x-2">
                <span>•</span>
                <span>
                  Don't hesitate to restart and try again - practice makes
                  perfect!
                </span>
              </li>
            </ul>
