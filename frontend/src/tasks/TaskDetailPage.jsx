                    ...
                    <div className="mt-6 p-6 bg-blue-50 rounded-xl border border-blue-200">
                        ...
                        <div className="space-y-3">
                            {options.map((option, index) => (
                                <label key={index} className="flex items-center p-4 bg-white rounded-lg border hover:bg-blue-50 cursor-pointer transition-colors">
                                    <input
                                        type="radio"
                                        name={`quiz-${task.id}`}
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-lg p-8">
                            ...
                            <p className="text-red-800 mb-4">
                                {error?.response?.status === 404 
                                    ...
                                    : error?.message || 'Failed to load the task. Please try again.'
                                }
                            </p>
    ...
    return (
        <Layout>
            <div className="max-w-4xl mx-auto">
                    ...
                    <div className="p-6">
                            ...
                            <div className="flex items-start space-x-4 flex-1">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        {/* Task Type */}
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${taskConfig.bgColor} ${taskConfig.color}`}>
                                            {taskConfig.label}
                                        </span>
                                        
                                        {/* Difficulty */}
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${difficultyConfig.bgColor} ${difficultyConfig.color}`}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div className="bg-blue-50 p-4 rounded-lg">
                                ...
                                <p className="text-2xl font-bold text-blue-700">{task.xp_reward}</p>
                            </div>
                            ...
                            {task.essence_reward > 0 && (
                                <div className="bg-purple-50 p-4 rounded-lg">
                                    ...
                                    <p className="text-2xl font-bold text-purple-700">{task.essence_reward}</p>
                                </div>
                            )}
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-green-700">
                                    Great job! You've successfully completed this task and earned {task.xp_reward} XP.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {/* Task Statistics */}
                {(task.completion_count > 0 || task.success_rate > 0 || task.average_completion_time) && (
                    <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {task.completion_count > 0 && (
                                <div className="text-center">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{task.completion_count}</p>
                            ...
                            {task.success_rate > 0 && (
                                <div className="text-center">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{Math.round(task.success_rate)}%</p>
                            ...
                            {task.average_completion_time && (
                                <div className="text-center">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{Math.round(task.average_completion_time)}m</p>
