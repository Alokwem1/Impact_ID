      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start space-x-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <h3
              className={`font-bold text-gray-900 ${viewMode === "list" ? "text-base" : "text-lg"}`}
            >
              {task.title}
            </h3>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2">
              {/* Task Type */}
              <span
                className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${taskConfig.bgColor} ${taskConfig.color}`}
              >
                {taskConfig.label}
              </span>
              ...
              {/* Difficulty */}
              <span
                className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${difficultyConfig.bgColor} ${difficultyConfig.color}`}
              >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-600">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span>
                {task.user_attempts_used || 0}/{task.max_attempts} attempts
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between text-xs text-gray-500">
              ...
              {task.average_completion_time && (
                <span className="flex items-center space-x-1">
                  <ClockIcon className="h-3 w-3" />
                  <span>
                    Avg: {Math.round(task.average_completion_time)}min
                  </span>
                </span>
              )}
            </div>
