...
const DIFFICULTY_LEVELS = {
    beginner: { label: 'Beginner', color: 'text-green-600', bgColor: 'bg-green-50', borderColor: 'border-green-200' },
    intermediate: { label: 'Intermediate', color: 'text-yellow-600', bgColor: 'bg-yellow-50', borderColor: 'border-yellow-200' },
    advanced: { label: 'Advanced', color: 'text-orange-600', bgColor: 'bg-orange-50', borderColor: 'border-orange-200' },
    expert: { label: 'Expert', color: 'text-red-600', bgColor: 'bg-red-50', borderColor: 'border-red-200' }
};
...
export default function TaskList() {
    ...
    const handleCompletionFilter = useCallback((status) => {
        ...
        return (
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                <div className="flex items-center justify-center text-center">
                    <div>
                        <p className="text-red-800 mb-4">{error?.message || 'Failed to load tasks.'}</p>
                        <button
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        ...
                        {filters.difficulty && ` • ${DIFFICULTY_LEVELS[filters.difficulty]?.label}`}
                    </p>
                </div>
                ...
                <div className="flex items-center space-x-2 mt-4 sm:mt-0">
                    ...
                    <button
                        ...
                        className={`flex items-center space-x-1 px-3 py-2 rounded-lg border transition-colors ${
                            showFilters || Object.values(filters).some(v => v && v !== 20 && v !== 0)
            ...
            {(filters.category || filters.difficulty || filters.completed !== null || searchTerm) && (
            ...
            {filteredTasks.length > 0 ? (
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">
                        {searchTerm || Object.values(filters).some(v => v && v !== 20 && v !== 0)
