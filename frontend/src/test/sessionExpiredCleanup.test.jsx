...
const responses = {
  me: { id: 1, username: 'persisted', email: 'p@example.com', role: 'user', xp: 5, is_verified: true }
};
...
describe('Session Expired cleanup', () => {
  test('clears tokens and prevents old token usage in subsequent calls', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('mini-dashboard')).toHaveTextContent(/persisted/i));
