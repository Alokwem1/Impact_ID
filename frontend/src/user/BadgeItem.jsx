...
export default function BadgeItem({ badge, showProgress = false, variant = 'default', onClick = null }) {
    const [isSharing, setIsSharing] = useState(false);
    
    // Get rarity configuration
    const rarityConfig = RARITY_CONFIG[badge.rarity?.toLowerCase()] || RARITY_CONFIG.common;
    const CategoryIcon = CATEGORY_ICONS[badge.category?.toLowerCase()] || TrophyIcon;
    const RarityIcon = badge.is_earned ? rarityConfig.iconSolid : rarityConfig.icon;
            ...
            >
                ...
                <div className="flex-grow min-w-0">
                    <div className="flex items-center space-x-2">
                        <p className={`font-semibold truncate ${badge.is_earned ? rarityConfig.textColor : 'text-gray-700'}`}>
                            {badge.title}
                        </p>
                    ...
                    {showProgress && !badge.is_earned && badge.progress_percentage !== undefined && (
                        <div className="mt-1">
    ...
    return (
        ...
        >
            ...
            {badge.is_earned && (
                <div className={`absolute inset-0 bg-gradient-to-br ${rarityConfig.color} opacity-5 rounded-xl`} />
            )}
            ...
            <div className="relative mb-4">
                <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center ${
                    ...
                    <RarityIcon className={`w-12 h-12 ${badge.icon_url ? 'hidden' : 'block'}`} />
                </div>
                ...
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                        ...
                        <CategoryIcon className={`w-4 h-4 ${badge.is_earned ? rarityConfig.textColor : 'text-gray-500'}`} />
                    </div>
                </div>
            </div>
            ...
            <div className="text-center space-y-3">
                ...
                <div className="space-y-1">
                    <h3 className={`font-bold text-lg ${badge.is_earned ? rarityConfig.textColor : 'text-gray-800'}`}>
                        {badge.title}
                    </h3>
