...
const ActivityItem = ({ activity }) => {
  ...
  return (
    <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
      <div
        className={`w-8 h-8 ${getActivityColor(activity.action)} rounded-full flex items-center justify-center flex-shrink-0`}
      >
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-gray-600">
                  ...
                  {profileStats.nextLevelXp.toLocaleString()} XP
                </span>
              </div>
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {profile.total_threads_woven || profile.weaving_streak || 0}
                </span>
              </div>
            </div>
          </div>
                ...
                {activitiesLoading ? (
                  <div className="space-y-3">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="animate-pulse flex space-x-3 p-3 bg-gray-50 rounded-lg"
                      >
