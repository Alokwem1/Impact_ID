      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Hi {user?.username}! Please verify your email address to access all
            Impact ID features.
          </p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 text-left">
            ...
            {requiredPermissions && (
              <p className="text-sm text-gray-700">
                ...
                {formatPermissions(requiredPermissions)}
              </p>
            )}
          </div>
...
const AccountStatusRestricted = ({ status }) => {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br ${statusInfo.bgColor} flex items-center justify-center p-4`}
    >
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-8">
        <div className="text-center">
          <div
            className={`mx-auto w-16 h-16 ${statusInfo.iconBg} rounded-full flex items-center justify-center mb-6`}
          >
