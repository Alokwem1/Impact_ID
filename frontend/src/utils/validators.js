...
export function validateUsername(username) {
    ...
    if (username.startsWith('_') || username.endsWith('_')) {
        return { isValid: false, error: 'Username cannot start or end with underscores' };
    }
    ...
    const reservedUsernames = [
        ...
        'support', 'help', 'info', 'contact', 'service', 'system',
        'null', 'undefined', 'anonymous', 'guest', 'user', 'users',
        'impact', 'impactid', 'impact_id', 'moderator', 'mod',
...
export function getPasswordStrength(password) {
    ...
    if (!/[!@#$%^&*(),.?":{}|<>]/.test(password)) feedback.push('Add special characters for extra security');
...
export function validateRegistrationForm({ username, email, password, confirmPassword, fullName = '' }) {
    const errors = {};
